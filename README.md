...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 98.21% | 87.84% | 98.03% | [#53](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/31558668478) |

Last updated from `master` at 2026-08-12 03:00 UTC for commit `ed54a0b`.
<!-- ci-status:end -->
