...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 99.07% | 85.29% | 98.65% | [#30](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/28652243912) |

Last updated from `master` at 2026-07-03 09:42 UTC for commit `8027a2e`.
<!-- ci-status:end -->
