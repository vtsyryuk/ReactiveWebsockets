...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 99.07% | 85.29% | 98.65% | [#28](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/28638685418) |

Last updated from `master` at 2026-07-03 04:36 UTC for commit `d3ce534`.
<!-- ci-status:end -->
