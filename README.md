...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 99.07% | 85.29% | 98.65% | [#33](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/28766791562) |

Last updated from `master` at 2026-07-06 03:59 UTC for commit `691c1bf`.
<!-- ci-status:end -->
