...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 99.10% | 85.71% | 98.76% | [#15](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/28637548696) |

Last updated from `master` at 2026-07-03 04:03 UTC for commit `dcd579a`.
<!-- ci-status:end -->
