...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 99.10% | 85.71% | 98.76% | [#16](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/28637780583) |

Last updated from `master` at 2026-07-03 04:09 UTC for commit `ebcf479`.
<!-- ci-status:end -->
