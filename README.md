...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 99.07% | 85.29% | 98.65% | [#27](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/28638454820) |

Last updated from `master` at 2026-07-03 04:29 UTC for commit `3117a5f`.
<!-- ci-status:end -->
