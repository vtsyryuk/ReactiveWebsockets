...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 98.21% | 87.84% | 98.03% | [#56](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/31558847763) |

Last updated from `master` at 2026-08-12 03:04 UTC for commit `f3cd695`.
<!-- ci-status:end -->
