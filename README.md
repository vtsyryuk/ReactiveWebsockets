...
| --- | ---: | ---: | ---: | --- |
| ✅ Passing | 98.21% | 87.84% | 98.03% | [#42](https://github.com/vtsyryuk/ReactiveWebsockets/actions/runs/29199762594) |

Last updated from `master` at 2026-07-12 16:15 UTC for commit `9d8ed16`.
<!-- ci-status:end -->
